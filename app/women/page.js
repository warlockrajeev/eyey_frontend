...
export default function WomenEyeglassesPage() {
  ...
  const filters = {
    ...
    "Frame Shape": ["Cat Eye", "Round", "Oval", "Rectangle", "Square"],
    "Frame Color": ["Pink", "Gold", "Rose Gold", "Purple", "Transparent", "Black"],
    "Frame Material": ["Acetate", "Metal", "TR90", "Titanium"],
    Brands: ["Vogue", "Ray-Ban", "Titan", "Fastrack"],
    Collections: ["Chic", "Elegant", "Trendy", "Premium"],
